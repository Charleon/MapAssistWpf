...
namespace MapAssist.Settings
{
    ...
    public class RenderingConfiguration : ConfigurationBase
    {
        ...
        protected override void ReadFromConfiguration()
        {
            ...
            X = ConfigurationReader.ReadInt16("X");
            Y = ConfigurationReader.ReadInt16("Y");
    ...
    public class MapConfiguration : ConfigurationBase
    {
        ...
        public SKColor WarnNPCFontColor { get; set; }
    ...
    public class MapColorConfiguration : ConfigurationBase
    {
        ...
        readonly Dictionary<int, SKColor?> _mapColors = new Dictionary<int, SKColor?>();
        ...
        public SKColor? LookupMapColor(int type)
        {
