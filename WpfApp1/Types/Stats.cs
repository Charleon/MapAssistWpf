...
namespace MapAssist.Types
{
    ...
    {
        public static Dictionary<Resist, SKColor> ResistColor = new Dictionary<Resist, SKColor>
        {
            { Resist.PHYSICAL, SKColors.Peru },
            { Resist.MAGIC, SKColors.OrangeRed },
            { Resist.FIRE, SKColors.Red },
            { Resist.LIGHTNING, SKColors.Yellow },
            { Resist.COLD, SKColors.CornflowerBlue },
            { Resist.POISON, SKColors.LimeGreen },
